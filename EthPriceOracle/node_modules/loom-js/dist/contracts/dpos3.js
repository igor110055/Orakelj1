...
var DPOS3 = /** @class */ (function (_super) {
    ...
    DPOS3.prototype.getStateAsync = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var req, res, state, params, maxYearlyRewards, totalWeightedAmountStaked;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        req = new dposv3_pb_1.GetStateRequest();
                        return [4 /*yield*/, this.staticCallAsync('GetState', req, new dposv3_pb_1.GetStateResponse())];
                    case 1:
                        res = _a.sent();
                        state = res.getState();
                        params = state.getParams();
                        maxYearlyRewards = big_uint_1.unmarshalBigUIntPB(params.getMaxYearlyReward());
                        totalWeightedAmountStaked = big_uint_1.unmarshalBigUIntPB(state.getTotalValidatorDelegations());
                        return [2 /*return*/, {
                                maxYearlyRewards: maxYearlyRewards,
                                totalWeightedAmountStaked: totalWeightedAmountStaked
                            }];
                }
            });
        });
