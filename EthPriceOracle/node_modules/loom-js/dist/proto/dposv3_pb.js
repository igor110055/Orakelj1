...
proto.ValidatorStatistic.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    jailed: jspb.Message.getFieldWithDefault(msg, 9, false)
  };
...
/**
 * optional bool jailed = 9;
 * Note that Boolean fields may be set to 0/1 when serialized from a Java server.
 * You should avoid comparisons like {@code val === true/false} in those cases.
 * @return {boolean}
 */
proto.ValidatorStatistic.prototype.getJailed = function() {
  return /** @type {boolean} */ (jspb.Message.getFieldWithDefault(this, 9, false));
};


/** @param {boolean} value */
proto.ValidatorStatistic.prototype.setJailed = function(value) {
